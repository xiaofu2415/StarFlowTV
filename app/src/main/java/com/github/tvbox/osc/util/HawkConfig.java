...
public class HawkConfig {
    ...
    public static final String LIVE_OFFICIAL_CHANNEL_ID = "last_live_official_channel_id";
    public static final String LIVE_OFFICIAL_QUALITY = "live_official_quality";
    ...
    public static final String STARFLOW_UPDATE_CHANNEL = "starflow_update_channel";
